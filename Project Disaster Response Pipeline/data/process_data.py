...
def clean_data(df):
    ...
    categories_to_remove = categories.columns[(categories == 0).all()].values
    categories.drop(categories_to_remove, axis=1, inplace=True)
    category_colnames.remove(categories_to_remove)
